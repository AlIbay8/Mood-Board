...
function happyMood() {
    ...
    happy["Imgs"].forEach(function(img) {
...
function hungryMood() {
    ...
    hungry["Imgs"].forEach(function(img) {
        $(".output").append("<div><img src='" + img + "'></div>");
    });
}
...
function excitedMood() {
    ...
    excited["Imgs"].forEach(function(img) {
        $(".output").append("<div><img src='" + img + "'></div>");
    });
}
...
function infuriatingMood() {
    ...
    infuriating["Imgs"].forEach(function(img) {
        $(".output").append("<div><img src='" + img + "'></div>");
    });
}
...
function tiredMood() {
    ...
    tired["Imgs"].forEach(function(img) {
        $(".output").append("<div><img src='" + img + "'></div>");
    });
}
...
function scaredMood() {
    ...
    scared["Imgs"].forEach(function(img) {
        $(".output").append("<div><img src='" + img + "'></div>");
    });
}
